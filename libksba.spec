...
Source0  : https://gnupg.org/ftp/gcrypt/libksba/libksba-1.5.0.tar.bz2
Source1  : https://gnupg.org/ftp/gcrypt/libksba/libksba-1.5.0.tar.bz2.sig
...
%prep
%setup -q -n libksba-1.5.0
cd %{_builddir}/libksba-1.5.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1605726474
...
cp %{_builddir}/libksba-1.5.0/COPYING.GPLv2 %{buildroot}/usr/share/package-licenses/libksba/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/libksba-1.5.0/COPYING.GPLv3 %{buildroot}/usr/share/package-licenses/libksba/e31db874e5b375f0592b02e3e450c9e94086e661
cp %{_builddir}/libksba-1.5.0/COPYING.LGPLv3 %{buildroot}/usr/share/package-licenses/libksba/f45ee1c765646813b442ca58de72e20a64a7ddba
%make_install
